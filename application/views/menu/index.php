...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="<?= base_url(); ?>menu/tambah" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenuModal"><i class="fas fa-fw fa-plus"></i> Menu Baru</a>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $m['menu_order']; ?></td>
                        <td>
                            <a href="<?= base_url() ?>menu/editMenu/<?= $m['id']; ?>" class="badge badge-success" data-toggle="modal" data-target="#editMenuModal"><i class="fas fa-fw fa-edit"></i>ubah</a>
